...
class ExecutionRecord:
    ...
    def __str__(self):
        return f'at {datetime.datetime.fromtimestamp(self.epoch_seconds)}, prices: {self.prices}, weights: {self.weights}, value: {self.value}, direction: {self.direction}'
...
class ClosedExecutionRecord:
    ...
    def __str__(self):
        ...
        return f'enter {self.record_enter}, exit {self.record_exit}, duration: {int((self.record_exit.epoch_seconds - self.record_enter.epoch_seconds) / 60)} minutes, pnl: {self.get_pnl()}'
